...
const create_idioma_idio_1 = require("./idio/create-idioma.idio");
const update_idioma_idio_1 = require("./idio/update-idioma.idio");
let IdiomaController = class IdiomaController {
    constructor(idiomaservice) {
        this.idiomaservice = idiomaservice;
    }
    create(createIdiomaidio) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_idioma_idio_1.CreateIdiomaIdio]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_idioma_idio_1.UpdateIdiomaIdio]),
    __metadata("design:returntype", void 0)
